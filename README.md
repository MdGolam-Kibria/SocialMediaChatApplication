...
- user can update her post ...if user have a post with image user can change the image if user want to change just post or description it can posssible now.
